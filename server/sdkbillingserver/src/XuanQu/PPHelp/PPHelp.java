...
//				byte busername[] = new byte[recvPSData.getLen() - (3 * 4 + 8)]; // »°
//																				// username
//																				// ◊÷Ω⁄≥§∂»Œ™
...
//
//				System.out.println("Recv from PP Server data length: "
//						+ recvPSData.getLen());
//				System.out.println("Recv from PP Server data command: "
//						+ recvPSData.getCommand());
//				System.out.println("Recv from PP Server data status: "
//						+ recvPSData.getStatus());
//				System.out.println("Recv from PP Server data username: "
//						+ recvPSData.getUsername());
//				System.out.println("Recv from PP Server data userid: "
//						+ recvPSData.getUserid());
//				return recvPSData;
//			}
//
//		} catch (Exception e) {
