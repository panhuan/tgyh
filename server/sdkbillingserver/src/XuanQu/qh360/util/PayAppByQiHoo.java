...
public class PayAppByQiHoo implements PayAppInterface {
	//TODO::需要修改为应用自身的app_key
	private String _appKey = "";
	//TODO::需要修改为应用自身的app_secret(服务器之间通讯使用)
	private String _appSecret = "";
	//TODO::人民币-游戏货币的兑换比例
	private int _cashRate = 100;
	
	private String verify_url = "";

	
	public PayAppByQiHoo()
	{
		try {
			_appKey = Util.getConfig("client_id");
			_appSecret = Util.getConfig("client_secret");
			verify_url = Util.getConfig("verify_url");
		} catch (Exception e) {
			e.printStackTrace();
		}
	}
