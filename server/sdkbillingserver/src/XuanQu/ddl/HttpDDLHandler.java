 ...
 * 
 */
public class HttpDDLHandler extends IoHandlerAdapter {
	...
	public void messageReceived(IoSession session, Object message) {
		...
		short c_pid = Short.parseShort(paymentString[2]);

		Double dAmount = new Double(money).doubleValue();

		if (sig) {
			String logMsg = "pid=" + c_pid;
