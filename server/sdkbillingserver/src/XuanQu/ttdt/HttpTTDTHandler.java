 ...
 * 
 */
public class HttpTTDTHandler extends IoHandlerAdapter {
	...
	public void messageReceived(IoSession session, Object message) {
		...
		// 提供给天天动听的充值签名验证key
		String key = "OEQxRTVCRTRDNjkwQ0RDNTc5NzEwQzAyN0UwQUMyQTREN0QxM0Q2QU1USTVNell3TlRJeU16azNNekkyTWpJM09ETXJNall4TlRrd05UQXhOall3TnpJeE5Ea3hORFF6T0Rnek5UUTFOVGs1TlRVNU1EWXhNRFk1";
		...
		if (sig) {
			String logMsg = "pid=" + SdkBillingServer.PID_TTDT;
			...
			if ("0".equals(result)) {
				_result = HttpSendPartBillServer
						.sendBillServerByServerId(nAccount, (int) (dAmount * 1), exorderno,
								paytype, SdkBillingServer.PID_TTDT, "", serverid);
			}
