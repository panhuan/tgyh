 ...
 *
 */
public class HttpMIUI {
	 private static final int DEFAULT_PORT = 6090;
	   ...
	   public void RunHttp() {
	       ...
	       try {
	           ...
	           acceptor.setHandler(new HttpMIUIHandler());
	           acceptor.bind(new InetSocketAddress(port));

	           System.out.println("Server now listening miui on port " + port);
	       } catch (Exception ex) {
	           ex.printStackTrace();
	       }
	   }
