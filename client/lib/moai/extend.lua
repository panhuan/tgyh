...
MOAIThread.extend (
	...
	function ( interface, class, superInterface, superClass )
		...
		-- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -
		function interface.attach(self, action, ...)
...
MOAIParticleSystem2D = MOAIParticleSystem

--============================================================--
-- MOAIParticleTimedEmitter
--============================================================--
MOAIParticleTimedEmitter.extend (
...
MOAIParticleTimedEmitter2D = MOAIParticleTimedEmitter
--============================================================--
-- MOAIParticleDistanceEmitter
--============================================================--
MOAIParticleDistanceEmitter.extend (
...
MOAIParticleDistanceEmitter2D = MOAIParticleDistanceEmitter
...
if MOAIHttpTask then
	MOAIHttpTask.get = function (httpUrl, onCallback, verbose)
		local task = MOAIHttpTask.new ()
		task:setVerb(MOAIHttpTask.HTTP_GET)
		task:setUrl(httpUrl)
		task:setVerbose(verbose)
		if onCallback then
			task:setCallback(onCallback)
			task:performAsync()
		else
			task:performSync()
		end
