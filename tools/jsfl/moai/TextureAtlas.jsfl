...
//----------------------------------------------------------------//
TextureAtlas.prototype.createTextureAtlas = function ( document ) {
	
	var packed = this.getPackListForLibrary ( document );
...
//----------------------------------------------------------------//
TextureAtlas.prototype.createTextureAtlasDoc = function ( document ) {
...
TextureAtlas.prototype.getPackListForLibrary = function ( document ) {
